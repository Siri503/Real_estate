...
export const Listing = () => {
  ...
  return (
    <main>
      ...
      {error && <p className='text-center my-7 text-2xl'>Error occurred while fetching data.</p>}
      ...
      <div className='fixed top-[13%] right-[13%] z-10 border rounded-full w-12 h-12 flex justify-center items-center bg-slate-100 cursor-pointer'>
       ...
       <div className='flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4'>
         ...
         <div className='flex gap-4'>
          ...
          {listing.offer && (
            <p className='bg-green-900 w-full max-w-[200px] text-white rounded-md p-1 text-center'>
         ...
         </ul>
        {
         ...
         <button onClick={()=>setContact(true)} className='p-3 text-white rounded-lg uppercase bg-slate-700 hover:opacity-95'>Contact Landlord</button>
         )}
